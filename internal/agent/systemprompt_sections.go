...
func buildTeamWorkspaceSection(teamWsPath string) []string {
	...
	return []string{
		...
		"Shared attachments and handoff files live here. If a personal working directory is shown elsewhere, prefer this team workspace path for shared files.",
		"Use this path directly for shared attachments and outputs; do not guess ../../../teams/... paths.",
		"",
		"## Auto-Status Updates",
